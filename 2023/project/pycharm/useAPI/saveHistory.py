...
4.保存到文件
"""
def historyDataSell(history_file):
...
# 历史交易csv
history_file = file_in + '/HistoryDealsDataTable_ATR5X02_1_1_sell.csv'
# 保存file  CSV文件路径
csv_file_change = 'HistoryDealsDataTable_ATR5X02_1_1_sell.csv'

# KDATA关联历史交易数据 并写入csv
type_his = historyDataSell(history_file)
