...
# 二进制文件路径
file_in = 'F:/mt5D/MetaTrader 5/Tester/Agent-127.0.0.1-3000/MQL5/Files'
# file_in = 'F:/Data/2021'
bin_file_k = file_in + '/Kdata_bin'
bin_file_15M = file_in + '/15M_bin'
bin_file_30M = file_in + '/30M_bin'
bin_file_1H = file_in + '/1H_bin'
bin_file_1D = file_in + '/1D_bin'
# 历史交易csv
history_file = file_in + '/HistoryDealsDataTable.csv'
# 保存file  CSV文件路径
csv_file_change = 'Data_5M21_2023.csv'
# 获得K线data
